  ...
  <?php include('includes/header.php');?>
   ...
   <main class="mn-inner">
	...
	<div class="input-field col  s12">
		...
		<input  name="empcode" id="empcode" type="text" autocomplete="off" required> <!-- onBlur="checkAvailabilityEmpid()" -->
	...
	<div class="input-field col s12">
		...
		<input  name="email" type="email" id="email" autocomplete="off" required> <!-- onBlur="checkAvailabilityEmailid()" -->
