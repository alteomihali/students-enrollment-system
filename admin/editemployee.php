...
$sql="update tblemployees set FirstName=:fname,LastName=:lname,Gender=:gender,Dob=:dob,Department=:department,Address=:address,City=:city,Country=:country,Phonenumber=:mobileno,ID_D=:did where id=:eid";
...
?> 
	    ...
	    <div class="input-field col  s12">
		<label for="deptcode">Dept ID</label>
		<input  name="deptcode" id="deptcode" value="<?php echo htmlentities($result->ID_D);?>" type="number" autocomplete="off" required>
		</div>
