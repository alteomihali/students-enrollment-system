...
$msg="Department type updated Successfully";
...
<html lang="en">
    <head>
        ...
        <title>Admin | Edit Dept Type</title>
  ...
  <?php include('includes/header.php');?>
       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title">Edit Department Type</div>
                    </div>
...
<input id="leavetype" type="text"  class="validate" autocomplete="off" name="leavetype" value="<?php echo htmlentities($result->LeaveType);?>"  required>
                                                <label for="leavetype">Department Type</label>
                                            </div>
