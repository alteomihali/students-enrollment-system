                ...
                <nav class="cyan darken-1">
                    <div class="nav-wrapper row">
                        ...
                        <div class="header-title col s3">      
                            <span class="chapter-title">EMPL | Admin</span>
                        </div>
...
$sql = "SELECT tblleaves.id as lid,tblemployees.FirstName,tblemployees.LastName,tblemployees.EmpId,tblleaves.PostingDate 
	    FROM tblleaves JOIN tblemployees ON tblleaves.empid=tblemployees.id WHERE tblleaves.IsRead=:isread";
$query = $dbh -> prepare($sql);
$query->bindParam(':isread',$isread,PDO::PARAM_STR);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
				...
				?>  
                                    <li>
                                        ...
                                        <div class="notification">
                                            ...
                                            <div class="notification-text"><p><b><//?php echo htmlentities($result->FirstName." ".$result->LastName);?><br />(<//?php echo htmlentities($result->EmpId);?>)</b> Applied for Registration</p><span>at <//?php echo htmlentities($result->PostingDate);?></b</span></div>
                                        </div>
                                        </a>
                                    </li>
       <//?php }} ?>     
