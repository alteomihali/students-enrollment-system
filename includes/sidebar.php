...
{               ?>
  ...
  <li class="no-padding"><a class="waves-effect waves-grey" href="emp-changepassword.php"><i class="material-icons">settings_input_svideo</i>Change Password</a></li>
                    <li class="no-padding">
                        <a class="collapsible-header waves-effect waves-grey"><i class="material-icons">apps</i>Register<i class="nav-drop-icon material-icons">keyboard_arrow_right</i></a>
                        <div class="collapsible-body">
                            <ul>
                                <li><a href="apply-leave.php">Register Here</a></li>
                                <li><a href="leavehistory.php">History</a></li>
                           
                    
					</ul> </div>
					 <li class="no-padding">
                        <a href="contact.php" class="collapsible-header waves-effect waves-grey"><i class="material-icons">C</i>Communicate<i class="nav-drop-icon material-icons"></i></a>
                  </li>
				  <li class="no-padding">
